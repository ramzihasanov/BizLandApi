using BizLand.Business.Mapping;
...
{
    opt.SwaggerDoc("v1", new OpenApiInfo { Title = "BizLand", Version = "v1" });
...
{
    opt.UseSqlServer("Server=;Database=albizApi;Trusted_Connection=true;");
});
